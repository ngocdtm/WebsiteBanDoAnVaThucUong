...
namespace WebsiteBanDoAnVaThucUong
{
    public class EmailService : IIdentityMessageService
    {
        ...
        //    html += HttpUtility.HtmlEncode(@"Or copy and paste the following link into the browser: " + message.Body);
        //    #endregion
        ...
        //    SmtpClient smtpClient = new SmtpClient("smtp.gmail.com", 587); // Port 587 cho TLS
        //    smtpClient.EnableSsl = true;  // Kích hoạt SSL (TLS)

        //    // Lấy email và password từ AppSettings
        //    string email = ConfigurationManager.AppSettings["Email"].ToString();
        //    string password = ConfigurationManager.AppSettings["Password"].ToString();

        //    // Khởi tạo NetworkCredential với email và mật khẩu
        //    System.Net.NetworkCredential credentials = new System.Net.NetworkCredential(email, password);
        //    smtpClient.Credentials = credentials;

        //    // Đặt thời gian chờ để tránh bị lỗi timeout
